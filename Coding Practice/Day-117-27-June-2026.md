...
node {
    def envName = "dev"
    env.INSTITUTE_NAME = "CodrAcademy"
    env.TEAM = "DevOps"
...
- name: Deploy Serverless Lambda Function
  ...
  tasks:
    - name: Create Lambda function
      command: aws lambda create-function --function-name pathnex-lambda --runtime nodejs14.x --role arn:aws:iam::123456789012:role/lambda.zip

##  🔹 Terraform - Create DynamoDB Table for Serverless Application

resource "aws_dynamodb_table" "codr_table" {
    name = "codr-table"
    hash_key = "id"
