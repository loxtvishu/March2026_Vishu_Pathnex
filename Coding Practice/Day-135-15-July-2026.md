...
pipeline {
    ...
    post {
        sucess {
            slackSend(channel: "$SLACK_CHANNEL", message: "SUCESS: $INSTITUTE_NAME Build #${env.BUILD_NUMBER}")
        }
        failure {
