...
## 🔹 Terraform 
- Create EC2 (choose: c5.large / r5.2xlarge / r6i.4xlarge / c6i.8xlarge / c6.12xlarge)
- Security group
- Key pair
- EBS volume
- Output IP
...
## 🔹 Jenkins Pipeline 
you will learm to **combine all tasks into a realistic Jenkins Pipeline** with proper stages and tags.
...
- Monitoring Checks - execute shell scripts to cheks:
- CPU
- Memory
- Disk
- IP
...
- monitoring_checks - Shell scripts to chek:
- CPU
- Memory
- Disk
- IP
