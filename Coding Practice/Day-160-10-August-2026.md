...
pipeline {
     ...
     stages {
        ...
        stage('Push Docker Image') {
           steps {
              script {
                 docker.withRegistry('https://docker.io','docker-crendentials') {
...
FROM ubuntu:22.04
WORKDIR /opt/loxtvishu/devops-project
COPY. /opt/loxtvishu/devops-project/
CMD ["ls", "-l" "opt/loxtvishu/devops-project"]

# Real Path
/opt/loxtvishu/devops-project