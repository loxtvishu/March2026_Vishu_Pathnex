...
for item in Pathnes DevOps Training; do 
   echo "Item: $item"
done
...
you will learn how to **wun stages based on branch or parameter conditions**.
...
## 🔹 Terraform - EC2 with Security Group and EBS Volume resource "aws_security_group" "allow_ssh_http" {
    name: "allow_ssh_http"
...
resource "aws_instance" "pathnex_ec2" {
    ami = "ami-0abcd134ancd1234"
    instance_type = "t3.medium"
    security_groups = [ams_security_group.allow_ssh_http.name]
