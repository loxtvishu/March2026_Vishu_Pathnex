...
if systemctl is-active --quiet $SERVICE; than
...
# Day 16 - Advabced CloudFormation & Multi-Region Deployments
   ...
   script:
     - |
       if [ "$CI_COMMIT_REF_NAME" == "main" ]; then
          ...
          kuberctl --context=us-west apply -f kubernetes/dev-devlopment.yaml
       if