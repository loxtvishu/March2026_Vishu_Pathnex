  ...
  tasks: 
    - name: Write content to file
      copy: 
        ...
        content: |
          Welcome to Pathnex DevOps Training Today is Day 12

## 🔹 Terraform - RDS Skeleton

resource "aws_db_instance" "PathneRDS" {
  ...
  tasks:
    - name: Create Launch Configuration
      ec2_asg:
         ...
         max_size: 3
         desired_capacity: 2
         vpc_zone_identifier: subnet-123445768
...
resource "aws_instance" "pathnex_ec2" {
    ...
    security_groups = [aws_securtiy_group.allow_ssh_http.name]
    tags = {
        Name = "Pathnex-EC2
    }
}
...
build:
  stage: build
  script:
    - docker built -t pathnex-web-app.
