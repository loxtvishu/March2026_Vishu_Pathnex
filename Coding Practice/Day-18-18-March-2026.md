...
you will learn how to **simulate rollback if feployment fails**.
            ...
            steps {
                script {
                    try {
                        ...
                        Rolling back $INSTITUTE_NAME application..."
                    }
                }
            }
        }
...
resource "aws_autoscalling_group" "pathnex_asg" {
   ...
   launch_configration = aws_launch_congiguration.pathnex_config.id
}
...
spec:
   ...
   mindReplicas: 2
   maxReplicas: 10
   targetCPUUtilicationPercentage: 80
      ...
      stage('Blue-Green Deployment') {
         steps {
            script {
               ...
               sh 'kubectl apply -f kubenetes/green-deployment.yaml'
