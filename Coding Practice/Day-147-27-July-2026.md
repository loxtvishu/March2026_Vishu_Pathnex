...
- name: Deploy Serverless Lambda Function
  ...
  tasks:
    - name: Create Lambda Function
      command: aws lambda create-funtion --function-name pathnex-lambda --runtime nodejs14.x --role
      arn:aws:iam::12344456743:role/lambda.zip
...
spec:
  ...
  function: |
    module.exports = functionn(event, context) {
        context.succed('Hello World');
    }
