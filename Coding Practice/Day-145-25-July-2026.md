...
## 🔹 Shell Script - Count Files in Dirctory
...
You will learn how to **cache Mavan dependencies with realistic labels**.
...
# Day 25 - Continues Monitoring and Alearts
...
resource "aws_cloudwatch_metric_alarm" "pathnex_cpu_alarm" {
   ...
   comprison_operator = "GreaterThanThreeshold"
   evaluation_periods = "1"
   metric_name = "CPUCtilization"
   namespace = "AWS/EC2"
   period = "60"
   statistic = "Average"
   threeshold = "80"
