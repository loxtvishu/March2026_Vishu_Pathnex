...
record "aws_route53_record" "PathnexRecord" {
    zone_id = "Z1234567890"
...
spec:
  initContainers:
     - name: setup
       image: busybox
       command: ["sh", "-c", "echo Initialiazing; sleep 10"]
  containers:
     - name: main
       image: nginx
...
deploy:
  ...
  script:
    ...
    - aws ec2 run-instances --image-id ami-0abcd1234 --count 1
    --instance-type t2.micro --access-key $AWS_ACCESS_KEY
