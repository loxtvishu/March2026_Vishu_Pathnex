...
You will learn how to **handle multiple branches in Jenkins pipeines**.
...
## 🔹 GitLab CI/CD - Branch Specific Jobs
  ...
  tasks:
    - name: Create Launch Configuration
      ec2_asg:
        ...
        max_size: 3
        desired_capicity: 2
        vpc_zone_identifire: subnet-12345678
