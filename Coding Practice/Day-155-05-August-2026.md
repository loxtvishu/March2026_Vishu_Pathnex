...
You will learn how to **use CI varialbles in GitLab pipelines**.
...
# Docker File
FROM python:3.11
WORKDIR /opt/loxtvishu/python-app
COPY app.py /opt/loxtvishu/python-app/
CMD ["python", "/opt/loxtvishu/python-app/app.py"]
