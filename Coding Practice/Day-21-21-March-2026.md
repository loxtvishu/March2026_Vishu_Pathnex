...
You must rewrite all from scratch:
...
pipeline {
    ...
    stages {
        ...
        stage('Deploy to Staging') {
            steps {
                input messsage: "Approve Staging Deployment?"
...
resource "aws_s3_bucket" "pathnec_backup_bucket_eu" {
