...
You will learn how to **rum jobs for specific branches in GitLab CI**.
...
## 🔹 Terraform - Create a Load Balancr with EC2 Instances
...
## 🔹 Kubernetes - Horizontal Pod Autoscaler (HPA) Load Balancer
apiVersion: apps/v1
kind: Deployment
metadata:
